(function () {
  ...
  var scenes = [
    { value: 'entrance', label: '玄関', english: 'apartment entrance area', environment: 'compact entryway, shoe cabinet, clean floor, doorway, wall finish, natural indoor light', details: 'entry door, shoe cabinet, floor area, doorway depth, interior circulation visible', opening: 'a quiet everyday moment inside a Japanese apartment, a young woman casually present in the space', actions: ['open-door', 'look-room', 'walk-lightly', 'turn-back', 'look-smartphone'], shots: ['diagonal-front', 'from-side', 'medium', 'full-body'] },
    { value: 'living-room', label: 'リビング', english: 'living room of a rental apartment', environment: 'bright living area, sofa, table, window, flooring, room depth, uncluttered interior, daylight', details: 'sofa, table, window, flooring, room depth, layout visible', opening: 'a natural everyday scene in a Japanese apartment interior, a young woman casually present in the space', actions: ['look-room', 'walk-lightly', 'turn-back', 'sit-sofa', 'touch-fixture', 'think-lightly', 'look-smartphone'], shots: ['diagonal-front', 'from-side', 'wide', 'medium', 'full-body'] },
    { value: 'kitchen', label: 'キッチン', english: 'apartment kitchen', environment: 'compact clean kitchen, counter, sink, stove, cabinet, practical storage, bright neutral lighting', details: 'counter, sink, stove, cabinet, kitchen layout visible', opening: 'a quiet everyday moment inside a Japanese apartment, a young woman casually present in the space', actions: ['look-kitchen', 'open-storage', 'touch-fixture', 'look-smartphone', 'think-lightly'], shots: ['diagonal-front', 'from-side', 'medium'] },
    { value: 'bathroom', label: 'バスルーム', english: 'rental apartment bathroom', environment: 'clean bathroom area, sink, mirror, bathroom fixtures, bright reflective surfaces, tidy space', details: 'sink, mirror, bathroom fixtures, wall surfaces visible', opening: 'a natural everyday scene in a Japanese apartment interior, a young woman casually present in the space', actions: ['look-room', 'touch-fixture', 'think-lightly'], shots: ['diagonal-front', 'from-side', 'medium'] },
    { value: 'toilet', label: 'トイレ', english: 'apartment toilet room', environment: 'small clean toilet room, toilet fixture, wall finish, compact layout, neutral light', details: 'toilet fixture, wall finish, room scale, doorway context visible', opening: 'a quiet everyday moment inside a Japanese apartment, a young woman casually present in the space', actions: ['look-room', 'touch-fixture', 'think-lightly'], shots: ['diagonal-front', 'from-side', 'medium'] },
    { value: 'washroom', label: '洗面所', english: 'apartment washroom', environment: 'clean vanity area, mirror, sink, storage under the basin, compact utility space, bright light', details: 'sink, mirror, vanity storage, utility layout visible', opening: 'a natural everyday scene in a Japanese apartment interior, a young woman casually present in the space', actions: ['look-room', 'touch-fixture', 'look-smartphone'], shots: ['diagonal-front', 'from-side', 'medium'] },
    { value: 'storage', label: '収納', english: 'storage space in the apartment', environment: 'closet or storage area, closet door, storage depth, shelving, clean walls, realistic apartment interior', details: 'closet door, storage depth, shelving, room connection visible', opening: 'a quiet everyday moment inside a Japanese apartment, a young woman casually present in the space', actions: ['open-storage', 'look-room', 'think-lightly'], shots: ['front', 'diagonal-front', 'from-side', 'medium'] },
    { value: 'window-side', label: '窓際', english: 'window side inside the apartment', environment: 'daylight near a large window, curtain rail, wall and flooring, bright room edge, airy interior feeling', details: 'window, wall finish, flooring, room depth, exterior light visible', opening: 'a natural everyday scene in a Japanese apartment interior, a young woman casually present in the space', actions: ['look-outside', 'look-room', 'turn-back', 'walk-lightly'], shots: ['diagonal-front', 'from-side', 'from-back', 'wide', 'full-body'] },
    { value: 'balcony', label: 'ベランダ', english: 'apartment balcony', environment: 'small rental balcony, railing, floor surface, sliding door, city view, realistic exterior atmosphere', details: 'balcony railing, floor surface, sliding door, exterior openness visible', opening: 'a quiet everyday moment inside a Japanese apartment, a young woman casually present in the space', actions: ['look-outside', 'step-to-balcony', 'turn-back', 'walk-lightly'], shots: ['diagonal-front', 'from-side', 'from-back', 'wide', 'full-body'] },
    { value: 'hallway', label: '廊下', english: 'apartment hallway', environment: 'narrow clean hallway, indoor doors, wall finish, flooring, realistic apartment layout, balanced indoor light', details: 'hallway depth, indoor doors, flooring, circulation visible', opening: 'a natural everyday scene in a Japanese apartment interior, a young woman casually present in the space', actions: ['walk-lightly', 'turn-back', 'look-room', 'look-smartphone'], shots: ['diagonal-front', 'from-side', 'from-back', 'wide', 'full-body'] },
    { value: 'outside-front', label: '外観前', english: 'in front of the apartment building', environment: 'apartment entrance, building facade, doorway, surrounding building context, realistic urban neighborhood, daylight', details: 'apartment entrance, facade, doorway, building context clearly visible', opening: 'a natural everyday scene around a Japanese apartment building, a young woman casually present in the space', actions: ['look-room', 'walk-lightly', 'turn-back', 'look-smartphone', 'think-lightly'], shots: ['diagonal-front', 'from-side', 'wide', 'full-body'] },
    { value: 'shared-space', label: '共用部', english: 'shared corridor or common area', environment: 'shared corridor, entrance lighting, corridor details, wall finish, realistic building details, clean common facilities', details: 'hallway, entrance lighting, shared corridor details, common area depth visible', opening: 'a quiet everyday moment inside a Japanese apartment building, a young woman casually present in the space', actions: ['walk-lightly', 'turn-back', 'look-smartphone', 'look-room'], shots: ['diagonal-front', 'from-side', 'from-back', 'wide', 'full-body'] },
    { value: 'building-entrance', label: 'エントランス', english: 'building entrance lobby', environment: 'apartment entrance lobby, mailboxes, auto-lock area, polished common entrance, realistic building details', details: 'mailboxes, entrance lighting, doorway, lobby layout visible', opening: 'a quiet everyday moment inside a Japanese apartment building, a young woman casually present in the space', actions: ['walk-lightly', 'look-room', 'look-smartphone', 'think-lightly'], shots: ['diagonal-front', 'from-side', 'wide', 'full-body'] },
    { value: 'door-front', label: '室内ドア前', english: 'in front of an interior door inside the apartment', environment: 'indoor doorway, wall finish, flooring, realistic apartment circulation, natural interior light', details: 'interior door, flooring, wall finish, circulation visible', opening: 'a natural everyday scene in a Japanese apartment interior, a young woman casually present in the space', actions: ['open-door', 'turn-back', 'look-room', 'walk-lightly'], shots: ['diagonal-front', 'from-side', 'from-back', 'medium', 'full-body'] }
  ];

  var actions = [
    { value: 'open-door', label: 'ドアを開ける', phrase: 'standing naturally while opening the door gently' },
    { value: 'look-room', label: '部屋を見る', phrase: 'looking around casually with a relaxed posture' },
    { value: 'look-outside', label: '窓の外を見る', phrase: 'looking outside casually in a relaxed everyday moment' },
    { value: 'walk-lightly', label: '少し歩く', phrase: 'slowly walking through the space with a relaxed posture' },
    { value: 'turn-back', label: '振り返る', phrase: 'turning back slightly in a natural everyday movement' },
    { value: 'open-storage', label: '収納を開ける', phrase: 'standing naturally while opening the storage door' },
    { value: 'look-kitchen', label: 'キッチンを見る', phrase: 'looking around casually near the kitchen area' },
    { value: 'look-smartphone', label: 'スマホを見る', phrase: 'glancing at her smartphone briefly in a natural way' },
    { value: 'think-lightly', label: '少し悩む', phrase: 'pausing naturally with a relaxed posture' },
    { value: 'sit-sofa', label: 'ソファに座る', phrase: 'sitting naturally on the sofa with a relaxed posture' },
    { value: 'touch-fixture', label: '設備に軽く触れる', phrase: 'lightly touching furniture or a fixture in a casual way' },
    { value: 'step-to-balcony', label: 'ベランダに出ようとする', phrase: 'slowly stepping toward the balcony in a natural everyday movement' }
  ];
